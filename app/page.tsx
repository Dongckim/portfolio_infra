            ...
            <div className="flex w-full mt-4 mb-8 md:mb-10 px-4 sm:px-6 lg:px-8 justify-end">
              ...
              >
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-border bg-surface text-textPrimary shadow-sm transition hover:bg-surface/90 focus:outline-none focus:ring-2 focus:ring-accent"
                >
                ...
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-border bg-surface text-textPrimary shadow-sm transition hover:bg-surface focus:outline-none focus:ring-2 focus:ring-accent"
                >
                  <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
